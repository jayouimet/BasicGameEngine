...
#define HZ_HAT_CENTERED           0
#define HZ_HAT_UP                 1
#define HZ_HAT_RIGHT              2
#define HZ_HAT_DOWN               4
#define HZ_HAT_LEFT               8
#define HZ_HAT_RIGHT_UP           (HZ_HAT_RIGHT | HZ_HAT_UP)
#define HZ_HAT_RIGHT_DOWN         (HZ_HAT_RIGHT | HZ_HAT_DOWN)
#define HZ_HAT_LEFT_UP            (HZ_HAT_LEFT  | HZ_HAT_UP)
#define HZ_HAT_LEFT_DOWN          (HZ_HAT_LEFT  | HZ_HAT_DOWN)
